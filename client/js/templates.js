(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><nav class="ink-navigation"><ul class="menu horizontal black"><li class="heading"><a href="/">Home</a></li></ul></nav><main data-hook="page-container"></main></body>';
    };
    ...
    templatizer["pages"]["home"] = function tmpl_pages_home() {
        return '<section class="page home"><div class="ink-grid"><h2><a href="//youtu.be/09m0B8RRiEE" target="_blank">Welcome ninja apprentice!</a></h2><p>Remember, all of your power resides in the f12. Use it wisely.</p></div></section>';
    };
